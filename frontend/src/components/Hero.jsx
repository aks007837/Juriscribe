...
import heroImage from '@/images/heroIg.png'
    ...
    <Container className="relative flex gap-16 pt-20 pb-36 lg:mb-12 lg:pt-20">
      ...
      >
        <h1 className="max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          {' '}
          Your{' '}
          <span className="relative whitespace-nowrap text-[#875c53]">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute top-2/3 left-0 h-[0.58em] w-full fill-[#ddc6c3] "
            ...
            <span className="relative">Legal Assistants:</span>
          </span>{' '}
          Meet Juri and Scribe
        </h1>
        <p className="mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          {/* {!user.value && <b>Your Digital Legal Guru</b>} */}
          {user.value && (
            <b>
              Welcome! {user.value.fname} {user.value.lname}
            </b>
          )}
        </p>
      ...
      {/* hero image */}
      <div
        className="hidden w-1/2 sm:contents md:relative md:block md:flex-1"
